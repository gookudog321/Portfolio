            ...
            <section id="about" className={offset ?'mx ' :'mx animate__animated animate__zoomInUp'}>
                <div className="about-me">
                    <div>
                        ...
                        <p className="indent">สวัสดีคับผมทำงานเกี่ยวกับ Implement & Tester อยู่แถวกรุงเทพ รามอินทรา ชื่นชอบในเขียนเว็บไซต์ และการเขียนโค้ด เป้าหมายในอนาคต การสร้างแอปพลิเคชัน และภาษาใหม่ๆ</p>
